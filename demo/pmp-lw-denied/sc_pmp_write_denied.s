...
.data
check_data0:
	.byte 0x37, 0x01, 0x02, 0x80, 0x13, 0x11, 0x01, 0x02, 0x13, 0x51, 0x01, 0x02, 0xaf, 0x31, 0x11, 0x18
	.byte 0x67, 0x80, 0x0d, 0x00
...
finish:
	...
	la x28, final_gpr_values
	ld x27, 0(x28)
	bne x1, x27, comparison_fail
	ld x27, 8(x28)
	bne x2, x27, comparison_fail
	ld x27, 16(x28)
	bne x3, x27, comparison_fail
