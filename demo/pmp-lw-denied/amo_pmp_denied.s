...
.data
check_data0:
	.byte 0x37, 0x01, 0x02, 0x80, 0x13, 0x11, 0x01, 0x02, 0x13, 0x51, 0x01, 0x02, 0xaf, 0x30, 0x11, 0x00
	.byte 0x67, 0x80, 0x0c, 0x00
.data
check_data1:
...
finish:
	...
	la x9, final_gpr_values
	ld x25, 0(x9)
	bne x1, x25, comparison_fail
	ld x25, 8(x9)
	bne x2, x25, comparison_fail
