...
rvtest_entry_point:
	...
	la x19, trap_vector
	csrw mtvec, x19
	/* PMP configuration from a derived case: 2 entries */
	li x31, 0x20008001
	csrw pmpaddr0, x31
	li x31, 0x3fffffffffffff
	csrw pmpaddr1, x31
	li x31, 0x1f17	/* entries 0..1 */
	csrw pmpcfg0, x31

	/* Load general purpose registers */
	la x19, initial_gpr_values
	ld x1, 0(x19)
	ld x2, 8(x19)
...
finish:
	...
	ld x19, 0(x8)
	bne x1, x19, comparison_fail
	ld x19, 8(x8)
	bne x2, x19, comparison_fail
