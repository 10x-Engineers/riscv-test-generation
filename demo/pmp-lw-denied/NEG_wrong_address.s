...
rvtest_entry_point:
	...
	la x5, trap_vector
	csrw mtvec, x5
	/* PMP entry 0: deny *all* access to the 4KiB region at 0x80028000;
...
finish:
	...
	la x14, final_gpr_values
	ld x5, 0(x14)
	bne x1, x5, comparison_fail
	ld x5, 8(x14)
	bne x2, x5, comparison_fail
