...
.section .data0,"aw"
	.byte 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 65520
.data
check_data0:
	.byte 0x37, 0x01, 0x02, 0x80, 0x13, 0x11, 0x01, 0x02, 0x13, 0x51, 0x01, 0x02, 0xaf, 0x30, 0x01, 0x10
	.byte 0x67, 0x00, 0x0a, 0x00
.data
check_data1:
	.byte 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51
...
rvtest_entry_point:
	...
	li x31, 0x20008001	/* case: NA4 region [0x80020004,0x80020008) */
	csrw pmpaddr0, x31
	li x31, -1
	csrw pmpaddr1, x31
	li x31, 0x1f17	/* case: [0]=NA4|RWX unlocked, [1]=NAPOT|RWX */	/* [0]=L|NAPOT,no perms; [1]=NAPOT,RWX */
	csrw pmpcfg0, x31

	/* Load general purpose registers */
	la x20, initial_gpr_values
	ld x1, 0(x20)
	ld x2, 8(x20)
...
finish:
	...
	la x22, final_gpr_values
	ld x20, 0(x22)
	bne x1, x20, comparison_fail
	ld x20, 8(x22)
	bne x2, x20, comparison_fail
...
.align 2
trap_vector:
	/* Trap-aware handler (--expect-trap-cause=5): the tested
